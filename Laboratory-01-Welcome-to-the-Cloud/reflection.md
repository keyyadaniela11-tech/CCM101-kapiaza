...
Building the GitHub portfolio structure was also a valuable experience. I had to be careful with file paths to avoid creating duplicate folders, which helped me better understand how GitHub handles nested directories when creating files directly through the browser.

Overall, this activity gave me hands-on exposure to a real cloud-based Linux environment for the first time, and it made me more confident about using KillerCoda and the terminal in future labs.
